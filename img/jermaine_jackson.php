          ...
          <div id="contenido">
            ...
            <article class="vida_carrera">
                ...
                <div id="izq">
    						...
    						<p>
                  Jermaine La Jaune Jackson (Gary, Indiana, Estados Unidos; 11 de diciembre de 1954) es un cantante, bajista y compositor de urban, soul y quiet storm. Hermano mayor de Michael Jackson y Janet Jackson.
                  También es conocido como Muhammad Abdul Aziz desde que se convirtió al Islam en la década de los 80. Es el cuarto de los nueve hijos de Katherine y Joseph Jackson. Bajista y vocalista de The Jackson 5,
                  Jermaine dejó el grupo luego de su cambio de casa discográfica (de Motown a CBS) a mediados de los 70, siendo reemplazado por su hermano menor Randy. Sin embargo, volvió al grupo en 1984 para su exitosa
                  gira "Victory". Jermaine también saltó a la fama por grabar varios duetos con la cantante Whitney Houston en sus primeros años como solista. Su éxito más grande fue "When the Rain Begins to Fall" cantado
                  a dueto en 1984 con la actriz y cantante Pia Zadora.
               </p>
               </div>
                <div id="dcha">
                <img src="http://jermainejackson5.com/images/profile/JermaineJackson_2017.jpg" alt="imagen_titulo_base" width='300' height='300'>
                </div>
    					</section>
    				</article>
    			</div>

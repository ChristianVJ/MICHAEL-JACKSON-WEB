...
<html lang="es">
      ...
      <head>
          <title> Michael Jackson - Histórico de compras </title>
      ...
      <body>
        ...
        <?php  HTMLheader(); ?>
          ...
          <div id="contenido">
            ...
            <?php
            $consulta = 'SELECT * FROM pedidos WHERE estado_pedido = "aceptado" order by fecha_pedido_procesado';
            $resultado = consultarA($consulta);

            echo '<table class= "tabla_conciertos">';
            echo '<tr><th>ID Pedido</th><th>Estado</th><th>Gestor encargado</th><th>Fecha procesado</th><th>Info extra</th><th>Disco solicitado</th></tr>';
            ...
            <div id="contenido">
              ...
              <?php
              $consulta = 'SELECT * FROM pedidos WHERE estado_pedido = "denegado" order by fecha_pedido_procesado';
              $resultado = consultarA($consulta);
              echo '<h3>DENEGADOS</h3>';
              echo '<table class= "tabla_conciertos">';
              echo '<tr><th>ID Pedido</th><th>Estado</th><th>Gestor encargado</th><th>Fecha procesado</th><th>Info extra</th><th>Disco solicitado</th></tr>';
              while ($registroActual = mysqli_fetch_array($resultado)) {
                  echo '<tr>';
